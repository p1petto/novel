...
define config.name = _("Любовь, деньги, шизофрения")
...
define gui.about = _p("История про обычного мальчика в необычной ситуации")
...
define build.name = "a_gift_of_fate_NO"
...
define config.save_directory = "novel-1662619146"
